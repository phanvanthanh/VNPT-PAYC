...
-- Dumping data for table vnptpayc.admin_resource: ~66 rows (approximately)
...
INSERT INTO `admin_resource` (`id`, `ten_hien_thi`, `resource`, `method`, `action`, `parameter`, `parameter_value`, `parent_id`, `created_at`, `updated_at`, `uri`, `status`, `show_menu`, `order`, `icon`) VALUES
	...
	(601, 'Đăng nhập', 'GET | App\\Http\\Controllers\\Auth\\LoginController@showLoginForm', 'GET', 'App\\Http\\Controllers\\Auth\\LoginController@showLoginForm', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'login', 1, 2, 1000, '<i class="icon-login"></i>'),
	(602, 'Nút đăng nhập', 'POST | App\\Http\\Controllers\\Auth\\LoginController@login', 'POST', 'App\\Http\\Controllers\\Auth\\LoginController@login', '', '', 601, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'login', 1, 2, 1000, NULL),
	(603, 'Đăng xuất', 'POST | App\\Http\\Controllers\\Auth\\LoginController@logout', 'POST', 'App\\Http\\Controllers\\Auth\\LoginController@logout', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'logout', 1, 2, 1000, '<i class="icon-logout"></i>'),
	(604, 'Đăng ký', 'GET | App\\Http\\Controllers\\Auth\\RegisterController@showRegistrationForm', 'GET', 'App\\Http\\Controllers\\Auth\\RegisterController@showRegistrationForm', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'register', 1, 2, 1000, '<i class="icon-user-following mx-0"></i>'),
	(605, 'Nút đăng ký', 'POST | App\\Http\\Controllers\\Auth\\RegisterController@register', 'POST', 'App\\Http\\Controllers\\Auth\\RegisterController@register', '', '', 604, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'register', 1, 2, 1000, NULL),
	(606, 'Reset mật khẩu', 'GET | App\\Http\\Controllers\\Auth\\ForgotPasswordController@showLinkRequestForm', 'GET', 'App\\Http\\Controllers\\Auth\\ForgotPasswordController@showLinkRequestForm', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'password/reset', 1, 2, 1000, '<i class="icon-key mx-0"></i>'),
	(607, 'Xác thực email', 'POST | App\\Http\\Controllers\\Auth\\ForgotPasswordController@sendResetLinkEmail', 'POST', 'App\\Http\\Controllers\\Auth\\ForgotPasswordController@sendResetLinkEmail', '', '', 606, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'password/email', 1, 2, 1000, NULL),
	(608, 'Lấy token reset mật khẩu', 'GET | App\\Http\\Controllers\\Auth\\ResetPasswordController@showResetForm', 'GET', 'App\\Http\\Controllers\\Auth\\ResetPasswordController@showResetForm', '', '', 606, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'password/reset/{token}', 1, 2, 1000, NULL),
	(609, 'Reset lại mật khẩu', 'POST | App\\Http\\Controllers\\Auth\\ResetPasswordController@reset', 'POST', 'App\\Http\\Controllers\\Auth\\ResetPasswordController@reset', '', '', 606, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'password/reset', 1, 2, 1000, NULL),
	(610, 'Xác nhận lại mật khẩu', 'GET | App\\Http\\Controllers\\Auth\\ConfirmPasswordController@showConfirmForm', 'GET', 'App\\Http\\Controllers\\Auth\\ConfirmPasswordController@showConfirmForm', '', '', 606, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'password/confirm', 1, 2, 1000, NULL),
	(611, 'Xác nhận lại mật khẩu lần 2', 'POST | App\\Http\\Controllers\\Auth\\ConfirmPasswordController@confirm', 'POST', 'App\\Http\\Controllers\\Auth\\ConfirmPasswordController@confirm', '', '', 606, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'password/confirm', 1, 2, 1000, NULL),
	(612, 'Danh mục quận huyện', 'GET | App\\Modules\\DmQuanHuyen\\Controllers\\DmQuanHuyenController@dmQuanHuyen', 'GET', 'App\\Modules\\DmQuanHuyen\\Controllers\\DmQuanHuyenController@dmQuanHuyen', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'dm-quan-huyen', 1, 1, 5, '<i class="menu-icon icon-location-pin"></i>'),
	(613, 'Nút import danh mục quận huyện', 'POST | App\\Modules\\DmQuanHuyen\\Controllers\\DmQuanHuyenController@dmQuanHuyenAndImport', 'POST', 'App\\Modules\\DmQuanHuyen\\Controllers\\DmQuanHuyenController@dmQuanHuyenAndImport', '', '', 612, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'dm-quan-huyen/import', 1, 2, 1000, NULL),
	(614, 'Danh mục phường xã', 'GET | App\\Modules\\DmXaPhuong\\Controllers\\DmXaPhuongController@dmXaPhuong', 'GET', 'App\\Modules\\DmXaPhuong\\Controllers\\DmXaPhuongController@dmXaPhuong', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'dm-xa-phuong', 1, 1, 6, '<i class="menu-icon icon-location-pin"></i>'),
	(615, 'Nút import danh mục phường xã', 'POST | App\\Modules\\DmXaPhuong\\Controllers\\DmXaPhuongController@dmXaPhuongAndImport', 'POST', 'App\\Modules\\DmXaPhuong\\Controllers\\DmXaPhuongController@dmXaPhuongAndImport', '', '', 614, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'dm-xa-phuong/import', 1, 2, 1000, NULL),
	(616, 'Nhóm quyền', 'GET | App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@nhomQuyen', 'GET', 'App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@nhomQuyen', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'nhom-quyen', 1, 1, 3, '<i class="menu-icon icon-people"></i>'),
	(617, 'Phân quyền', 'GET | App\\Modules\\PhanQuyen\\Controllers\\PhanQuyenController@phanQuyen', 'GET', 'App\\Modules\\PhanQuyen\\Controllers\\PhanQuyenController@phanQuyen', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'phan-quyen', 1, 1, 4, '<i class="menu-icon fa fa-sitemap"></i>'),
	(618, 'Danh sách chức năng', 'GET | App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@taiNguyen', 'GET', 'App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@taiNguyen', '', '', 1, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'tai-nguyen', 1, 1, 2, '<i class="menu-icon icon-list"></i>'),
	(620, 'Quét tài nguyên', 'POST | App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@quetTaiNguyen', 'POST', 'App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@quetTaiNguyen', '', '', 618, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'quet-tai-nguyen', 1, 2, 1000, NULL),
	(621, 'Thêm một tài nguyên', 'POST | App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@themTaiNguyen', 'POST', 'App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@themTaiNguyen', '', '', 618, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'them-tai-nguyen', 1, 2, 1000, NULL),
	(623, 'Sửa tài nguyên', 'POST | App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@capNhatTaiNguyen', 'POST', 'App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@capNhatTaiNguyen', '', '', 618, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'cap-nhat-tai-nguyen', 1, 2, 1000, NULL),
	(624, 'Xóa tài nguyên', 'POST | App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@xoaTaiNguyen', 'POST', 'App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@xoaTaiNguyen', '', '', 618, '2021-02-01 09:49:23', '2021-02-14 20:05:42', 'xoa-tai-nguyen', 1, 2, 1000, NULL),
	(626, 'Xem danh sách quyền', 'POST | App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@danhSachNhomQuyen', 'POST', 'App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@danhSachNhomQuyen', '', '', 616, '2021-02-02 07:59:22', '2021-02-14 20:05:42', 'danh-sach-nhom-quyen', 1, 2, 1000, NULL),
	(627, 'Thêm nhóm quyền', 'POST | App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@themNhomQuyen', 'POST', 'App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@themNhomQuyen', '', '', 616, '2021-02-02 07:59:22', '2021-02-14 20:05:42', 'them-nhom-quyen', 1, 2, 1000, NULL),
	(629, 'Cập nhật nhóm quyền', 'POST | App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@capNhatNhomQuyen', 'POST', 'App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@capNhatNhomQuyen', '', '', 616, '2021-02-02 07:59:22', '2021-02-14 20:05:42', 'cap-nhat-nhom-quyen', 1, 2, 1000, NULL),
	(630, 'Xóa nhóm quyền', 'POST | App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@xoaNhomQuyen', 'POST', 'App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@xoaNhomQuyen', '', '', 616, '2021-02-02 07:59:22', '2021-02-14 20:05:42', 'xoa-nhom-quyen', 1, 2, 1000, NULL),
	(631, 'Phân quyền', 'POST | App\\Modules\\PhanQuyen\\Controllers\\PhanQuyenController@phanQuyenPost', 'POST', 'App\\Modules\\PhanQuyen\\Controllers\\PhanQuyenController@phanQuyenPost', '', '', 617, '2021-02-02 07:59:22', '2021-02-14 20:05:42', 'phan-quyen-post', 1, 2, 1000, NULL),
	(632, 'Danh sách nhóm quyền (Phân quyền)', 'POST | App\\Modules\\PhanQuyen\\Controllers\\PhanQuyenController@phanQuyenDanhSachNhomQuyen', 'POST', 'App\\Modules\\PhanQuyen\\Controllers\\PhanQuyenController@phanQuyenDanhSachNhomQuyen', '', '', 617, '2021-02-02 07:59:22', '2021-02-14 20:05:42', 'phan-quyen/danh-sach-nhom-quyen', 1, 2, 1000, NULL),
	(633, 'Danh sách quyền theo nhóm quyền (Phân quyền)', 'POST | App\\Modules\\PhanQuyen\\Controllers\\PhanQuyenController@phanQuyenDanhSachQuyenTheoNhomQuyenId', 'POST', 'App\\Modules\\PhanQuyen\\Controllers\\PhanQuyenController@phanQuyenDanhSachQuyenTheoNhomQuyenId', '', '', 617, '2021-02-02 07:59:22', '2021-02-14 20:05:42', 'phan-quyen/danh-sach-quyen-theo-nhom-quyen-id', 1, 2, 1000, NULL),
	(636, 'Danh mục đơn vị', 'GET | App\\Modules\\DonVi\\Controllers\\DonViController@donVi', 'GET', 'App\\Modules\\DonVi\\Controllers\\DonViController@donVi', '', '', 1, '2021-02-02 15:38:41', '2021-02-14 20:05:42', 'don-vi', 1, 1, 2, '<i class="menu-icon fa fa-cubes"></i>'),
	(637, 'Xem danh sách đơn vị', 'POST | App\\Modules\\DonVi\\Controllers\\DonViController@danhSachDonVi', 'POST', 'App\\Modules\\DonVi\\Controllers\\DonViController@danhSachDonVi', '', '', 636, '2021-02-02 15:38:41', '2021-02-14 20:05:42', 'danh-sach-don-vi', 1, 2, 1000, NULL),
	(638, 'Thêm đơn vị', 'POST | App\\Modules\\DonVi\\Controllers\\DonViController@themDonVi', 'POST', 'App\\Modules\\DonVi\\Controllers\\DonViController@themDonVi', '', '', 636, '2021-02-02 15:38:41', '2021-02-14 20:05:42', 'them-don-vi', 1, 2, 1000, NULL),
	(640, 'Cập nhật đơn vị', 'POST | App\\Modules\\DonVi\\Controllers\\DonViController@capNhatDonVi', 'POST', 'App\\Modules\\DonVi\\Controllers\\DonViController@capNhatDonVi', '', '', 636, '2021-02-02 15:38:41', '2021-02-14 20:05:42', 'cap-nhat-don-vi', 1, 2, 1000, NULL),
	(641, 'Xóa đơn vị', 'POST | App\\Modules\\DonVi\\Controllers\\DonViController@xoaDonVi', 'POST', 'App\\Modules\\DonVi\\Controllers\\DonViController@xoaDonVi', '', '', 636, '2021-02-02 15:38:41', '2021-02-14 20:05:42', 'xoa-don-vi', 1, 2, 1000, NULL),
	(642, 'Đơn vị single', 'POST | App\\Modules\\DonVi\\Controllers\\DonViController@donViSingle', 'POST', 'App\\Modules\\DonVi\\Controllers\\DonViController@donViSingle', '', '', 636, '2021-02-04 13:30:50', '2021-02-14 20:05:42', 'don-vi-single', 1, 2, 1000, NULL),
	(643, 'To do', 'GET | App\\Modules\\ToDo\\Controllers\\ToDoController@toDo', 'GET', 'App\\Modules\\ToDo\\Controllers\\ToDoController@toDo', '', '', 653, '2021-02-04 13:30:50', '2021-02-14 20:05:42', 'to-do', 1, 1, 7, '<i class="icon-clock menu-icon"></i>'),
	(644, 'Danh sách to do', 'POST | App\\Modules\\ToDo\\Controllers\\ToDoController@danhSachToDo', 'POST', 'App\\Modules\\ToDo\\Controllers\\ToDoController@danhSachToDo', '', '', 653, '2021-02-04 13:30:50', '2021-02-14 20:05:42', 'danh-sach-to-do', 1, 2, 1000, NULL),
	(645, 'Thêm to do', 'POST | App\\Modules\\ToDo\\Controllers\\ToDoController@themToDo', 'POST', 'App\\Modules\\ToDo\\Controllers\\ToDoController@themToDo', '', '', 653, '2021-02-04 13:30:50', '2021-02-14 20:05:42', 'them-to-do', 1, 2, 1000, NULL),
	(647, 'Cập nhật to do', 'POST | App\\Modules\\ToDo\\Controllers\\ToDoController@capNhatToDo', 'POST', 'App\\Modules\\ToDo\\Controllers\\ToDoController@capNhatToDo', '', '', 653, '2021-02-04 13:30:50', '2021-02-14 20:05:42', 'cap-nhat-to-do', 1, 2, 1000, NULL),
	(648, 'Xóa to do', 'POST | App\\Modules\\ToDo\\Controllers\\ToDoController@xoaToDo', 'POST', 'App\\Modules\\ToDo\\Controllers\\ToDoController@xoaToDo', '', '', 653, '2021-02-04 13:30:50', '2021-02-14 20:05:42', 'xoa-to-do', 1, 2, 1000, NULL),
	(651, 'Nhóm quyền single', 'POST | App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@nhomQuyenSingle', 'POST', 'App\\Modules\\NhomQuyen\\Controllers\\NhomQuyenController@nhomQuyenSingle', '', '', 616, '2021-02-04 14:32:48', '2021-02-14 20:05:42', 'nhom-quyen-single', 1, 2, 1000, NULL),
	(652, 'To do single', 'POST | App\\Modules\\ToDo\\Controllers\\ToDoController@toDoSingle', 'POST', 'App\\Modules\\ToDo\\Controllers\\ToDoController@toDoSingle', '', '', 653, '2021-02-04 14:32:48', '2021-02-14 20:05:42', 'to-do-single', 1, 2, 1000, NULL),
	(653, 'To do', NULL, 'GET', NULL, NULL, NULL, 1, '2021-02-08 10:47:31', '2021-02-11 12:07:56', NULL, 1, 1, 8, '<i class="icon-clock menu-icon"></i>'),
	(661, 'Gửi PAYC', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@payc', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@payc', '', '', 1, '2021-02-11 12:53:18', '2021-02-14 20:05:42', 'payc', 1, 1, 9, '<i class="menu-icon fa fa-send"></i>'),
	(662, 'PAYC ẩn danh', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycAnDanh', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycAnDanh', '', '', 1, '2021-02-11 12:53:18', '2021-02-14 20:05:42', 'danh-sach-payc-an-danh', 1, 1, 10, '<i class="fa fa-list menu-icon"></i>'),
	(663, 'Thêm PAYC', 'POST | App\\Modules\\Payc\\Controllers\\PaycController@themPayc', 'POST', 'App\\Modules\\Payc\\Controllers\\PaycController@themPayc', '', '', 661, '2021-02-11 12:53:18', '2021-02-14 20:05:42', 'them-payc', 1, 2, 1000, NULL),
	(664, 'Danh sách chức năng', 'POST | App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@danhSachTaiNguyen', 'POST', 'App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@danhSachTaiNguyen', '', '', 618, '2021-02-11 12:53:18', '2021-02-14 20:05:42', 'danh-sach-tai-nguyen', 1, 2, 1000, NULL),
	(665, 'Tài nguyên Single', 'POST | App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@taiNguyenSingle', 'POST', 'App\\Modules\\TaiNguyen\\Controllers\\TaiNguyenController@taiNguyenSingle', '', '', 618, '2021-02-11 12:53:18', '2021-02-14 20:05:42', 'tai-nguyen-single', 1, 2, 1000, NULL),
	(666, 'Trang chủ', 'GET | App\\Modules\\TrangChu\\Controllers\\TrangChuController@home', 'GET', 'App\\Modules\\TrangChu\\Controllers\\TrangChuController@home', '', '', 1, '2021-02-11 12:53:18', '2021-02-14 20:05:42', '/', 1, 2, 1000, '<i class="fa fa-home menu-icon"></i>'),
	(667, 'PAYC của tôi', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycCuaToi', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycCuaToi', '', '', 1, '2021-02-11 18:17:59', '2021-02-14 20:05:42', 'danh-sach-payc-cua-toi', 1, 1, 1000, '<i class="icon-briefcase menu-icon"></i>'),
	(668, 'PAYC chờ tiếp nhận', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoTiepNhan', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoTiepNhan', '', '', 1, '2021-02-14 18:42:02', '2021-02-14 20:05:42', 'danh-sach-payc-cho-tiep-nhan', 1, 1, 1000, NULL),
	(669, 'danh-sach-payc-da-tiep-nhan', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaTiepNhan', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaTiepNhan', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-da-tiep-nhan', 1, 1, 1000, NULL),
	(670, 'danh-sach-payc-da-hoan-tat', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaHoanTat', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaHoanTat', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-da-hoan-tat', 1, 1, 1000, NULL),
	(671, 'danh-sach-payc-da-chuyen-xu-ly', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaChuyenXuLy', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaChuyenXuLy', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-da-chuyen-xu-ly', 1, 1, 1000, NULL),
	(672, 'danh-sach-payc-dang-xu-ly', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDangXuLy', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDangXuLy', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-dang-xu-ly', 1, 1, 1000, NULL),
	(673, 'danh-sach-payc-da-chuyen-lanh-dao-duyet', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaChuyenLanhDaoDuyet', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaChuyenLanhDaoDuyet', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-da-chuyen-lanh-dao-duyet', 1, 1, 1000, NULL),
	(674, 'danh-sach-payc-da-chuyen-lanh-dao-khac-duyet', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaChuyenLanhDaoKhacDuyet', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaChuyenLanhDaoKhacDuyet', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-da-chuyen-lanh-dao-khac-duyet', 1, 1, 1000, NULL),
	(675, 'danh-sach-payc-cho-duyet', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoDuyet', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoDuyet', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-cho-duyet', 1, 1, 1000, NULL),
	(676, 'danh-sach-payc-da-duyet', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaDuyet', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaDuyet', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-da-duyet', 1, 1, 1000, NULL),
	(677, 'danh-sach-payc-tra-lai-buoc-tiep-nhan', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycTraLaiBuocTiepNhan', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycTraLaiBuocTiepNhan', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-tra-lai-buoc-tiep-nhan', 1, 1, 1000, NULL),
	(678, 'danh-sach-payc-tra-lai-can-bo-xu-ly', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycTraLaiCanBoXuLy', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycTraLaiCanBoXuLy', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-tra-lai-can-bo-xu-ly', 1, 1, 1000, NULL),
	(679, 'danh-sach-payc-da-huy', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaHuy', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycDaHuy', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-da-huy', 1, 1, 1000, NULL),
	(680, 'danh-sach-payc-cho-khach-hang-danh-gia', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoKhachHangDanhGia', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoKhachHangDanhGia', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-cho-khach-hang-danh-gia', 1, 1, 1000, NULL),
	(681, 'danh-sach-payc-cho-lanh-dao-danh-gia', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoLanhDaoDanhGia', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoLanhDaoDanhGia', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-cho-lanh-dao-danh-gia', 1, 1, 1000, NULL),
	(682, 'danh-sach-payc-cho-can-bo-danh-gia', 'GET | App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoCanBoDanhGia', 'GET', 'App\\Modules\\Payc\\Controllers\\PaycController@danhSachPaycChoCanBoDanhGia', '', '', 1, '2021-02-14 20:05:42', '2021-02-14 20:05:42', 'danh-sach-payc-cho-can-bo-danh-gia', 1, 1, 1000, NULL);
...
INSERT INTO `payc` (`id`, `id_user_tao`, `id_dich_vu`, `so_phieu`, `tieu_de`, `noi_dung`, `file_payc`, `ngay_tao`, `han_xu_ly_mong_muon`, `han_xu_ly_duoc_giao`, `ngay_hoan_tat`, `trang_thai`) VALUES
	(1, 1, 1, NULL, 'tiêu đề 01', 'Nội dung 01', 'test.doc', '2020-02-04 17:00:00', NULL, NULL, NULL, 0),
	(2, 2, 2, NULL, 'tiêu đề 02', 'Nội dung 02', 'test2.docx', '2021-02-11 04:49:17', '2021-10-02 17:00:00', NULL, NULL, 0),
	(3, 2, 3, NULL, 'tiêu đề 03', 'Nội dung 03', 'test3.pdf', '2021-02-11 04:50:38', '2021-12-13 13:01:00', NULL, NULL, 0),
	(4, 2, NULL, NULL, NULL, NULL, NULL, '2021-02-11 04:50:59', '2021-12-13 13:01:00', NULL, NULL, 0),
	(5, 2, NULL, NULL, NULL, NULL, NULL, '2021-02-11 04:52:25', '2021-10-13 17:00:00', NULL, NULL, 0),
	(6, 1, NULL, NULL, NULL, NULL, NULL, '2021-02-11 05:37:27', '2021-02-11 17:00:00', NULL, NULL, 0),
	(7, 1, 1, NULL, 'kkk', 'kkkk', '', '2021-02-11 05:41:05', '2021-02-11 17:00:00', NULL, NULL, 0),
	(8, 1, NULL, NULL, NULL, 'g', '16129973730.jpg;16129973741.xls;16129973742.docx;', '2021-02-11 05:49:34', '2021-02-11 17:00:00', NULL, NULL, 0),
	(9, 1, NULL, NULL, NULL, 'sds', '16129992160.jpg;16129992161.xls;16129992162.docx;', '2021-02-11 06:20:16', '2021-02-11 17:00:00', NULL, NULL, 0),
	(10, 1, NULL, NULL, NULL, NULL, 'co-bac-bip.jpg_16129994230.jpg;lech_thuoc_luong_hoa.xls_16129994231.xls;test.docx_16129994232.docx;', '2021-02-11 06:23:43', '2021-02-11 17:00:00', NULL, NULL, 0),
	(11, 1, NULL, NULL, NULL, NULL, 'co-bac-bip_16129996110.jpg;lech_thuoc_luong_hoa_16129996111.xls;test_16129996112.docx;', '2021-02-11 06:26:51', '2021-02-11 17:00:00', NULL, NULL, 0),
	(12, 1, NULL, NULL, NULL, 'fsdfa', 'co-bac-bip - Copy_16130001070.jpg;lech_thuoc_luong_hoa - Copy_16130001071.xls;lech_thuoc_luong_hoa_16130001072.xls;test_16130001073.docx;', '2021-02-11 06:35:07', '2021-02-11 17:00:00', NULL, NULL, 0),
	(13, 1, NULL, NULL, NULL, 'ẹkfjds', 'co-bac-bip_16130002040.jpg;lech_thuoc_luong_hoa - Copy_16130002041.xls;lech_thuoc_luong_hoa_16130002042.xls;test_16130002043.docx;', '2021-02-11 06:36:44', '2021-02-11 17:00:00', NULL, NULL, 0),
	(14, 1, NULL, NULL, 'test', 'test', 'co-bac-bip_16130218560.jpg;lech_thuoc_luong_hoa - Copy_16130218561.xls;te.st_16130218562.docx;', '2021-02-11 12:37:36', '2021-02-11 17:00:00', NULL, NULL, 0),
	(15, 1, NULL, NULL, NULL, 'test', 'co-bac-bip_16130221120.jpg;lech_thuoc_luong_h.oa_16130221121.xls;lech_thuoc_luong_hoa - Copy_16130221122.xls;te.st_16130221123.docx;', '2021-02-11 12:41:52', '2021-02-11 17:00:00', NULL, NULL, 0),
	(16, 1, NULL, NULL, NULL, 'test', 'co-bac-bip_16130221200.jpg;lech_thuoc_luong_h.oa_16130221201.xls;lech_thuoc_luong_hoa - Copy_16130221202.xls;te.st_16130221203.docx;', '2021-02-11 12:42:00', '2021-02-11 17:00:00', NULL, NULL, 0),
	(17, 1, NULL, NULL, NULL, 'test', 'co-bac-bip_16130222210.jpg;lech_thuoc_luong_h.oa_16130222211.xls;lech_thuoc_luong_hoa - Copy_16130222212.xls;te.st_16130222213.docx;', '2021-02-11 12:43:41', '2021-02-11 17:00:00', NULL, NULL, 0),
	(18, 1, NULL, NULL, 'test', 'test', 'co-bac-bip - Copy_16130222930.jpg;', '2021-02-11 12:44:53', '2021-02-11 17:00:00', NULL, NULL, 0),
	(19, 1, NULL, NULL, NULL, 'test fsdfasdfa fsdfasdfdfasdf', 'co-bac-bip_16130224950.jpg;lech_thuoc_luong_hoa - Copy_16130224951.xls;te.st_16130224952.docx;', '2021-02-11 12:48:15', '2021-02-11 17:00:00', NULL, NULL, 0),
	(20, 1, NULL, NULL, NULL, '<p><b>fdsadfa</b></p><p><b style="background-color: rgb(255, 255, 0);">fsdte sdfasdfas</b></p><ul><li><b style="background-color: rgb(255, 255, 0);">dfasdf</b></li><li><b style="background-color: rgb(255, 255, 0);">sfsa</b></li></ul>', 'co-bac-bip_16130225590.jpg;lech_thuoc_luong_h.oa_16130225591.xls;lech_thuoc_luong_hoa - Copy_16130225592.xls;te.st_16130225603.docx;', '2021-02-11 12:49:20', '2021-02-11 17:00:00', NULL, NULL, 0);
...
-- Dumping data for table vnptpayc.payc_canbo_xuly_yeucau: ~6 rows (approximately)
...
INSERT INTO `payc_canbo_xuly_yeucau` (`id`, `id_payc`, `id_user_xu_ly`, `id_xu_ly`, `noi_dung_xu_ly`, `file_xu_ly`, `ngay_xu_ly`, `state`) VALUES
	(5, 1, 2, 1, NULL, NULL, '2021-02-13 15:14:34', 1),
	(6, 1, 2, 2, NULL, NULL, '2021-02-13 15:14:34', 1),
	(7, 1, 2, 3, NULL, NULL, '2021-02-13 15:14:34', 1),
	(8, 1, 2, 4, NULL, NULL, '2021-02-13 15:14:34', 1),
	(9, 2, 2, 1, NULL, NULL, '2021-02-13 15:14:34', 1),
	(11, 3, 2, 1, NULL, NULL, '2021-02-13 15:14:34', 1);
...
-- Dumping data for table vnptpayc.payc_trang_thai_xu_ly: ~15 rows (approximately)
/*!40000 ALTER TABLE `payc_trang_thai_xu_ly` DISABLE KEYS */;
INSERT INTO `payc_trang_thai_xu_ly` (`id`, `ten_trang_thai_xu_ly`, `mo_ta`, `trang_thai`) VALUES
	...
	(16, 'Đã duyệt', 'Đã được lãnh đạo duyệt', 1);
...
-- Dumping data for table vnptpayc.users_dich_vu: ~2 rows (approximately)
