    ...
    <div class="form-group row">
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-8">
           ...
           <TEXTAREA name="gia_tri_tham_so" class="form-control gia_tri_tham_so" rows="10">@if($checkData==1){{$data['gia_tri_tham_so']}}@endif</TEXTAREA>
        </div>
     </div>
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-8">
          <TEXTAREA name="mo_ta_tham_so" class="form-control mo_ta_tham_so" rows="10">@if($checkData==1) {{$data['mo_ta_tham_so']}} @endif</TEXTAREA>
        </div>
     </div>
