...
@section('content')
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <h4 class="text-danger">DANH MỤC LINK QUẢN TRỊ</h4>
                  </div>
                    <div class="col-6">
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-vnpt btn-them-moi"><i class="icon-check"></i> Thêm danh mục</button>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      loadTable(_token, "{{ route('danh-sach-dm-link-quan-tri') }}", '.load-danh-sach');

      $('.btn-them-moi').on('click',function(){
          themMoi(_token, $("form#frm-them-moi"), "{{ route('them-dm-link-quan-tri') }}", "{{ route('danh-sach-dm-link-quan-tri') }}", '.load-danh-sach');
          jQuery("#modal-them-moi").modal('hide');
      });

      $('.btn-load-form-them-moi').on('click',function(){
        getById(_token, "", "{{ route('dm-link-quan-tri-single') }}", ".frm-them-moi"); // gọi sự kiện lấy dữ liệu theo id
      });
