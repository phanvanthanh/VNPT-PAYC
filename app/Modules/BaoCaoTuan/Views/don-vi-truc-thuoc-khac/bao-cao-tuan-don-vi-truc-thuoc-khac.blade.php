        ...
        <div class="card">
            <div class="card-body">
                ...
                @php
                  ...
                  $isLanhDao=\Helper::kiemTraTaiKhoanThuocNhomChucVu($userId,'LANH_DAO');
                @endphp
                        ...
                        <form class="forms-sample frm-bao-cao-tuan" id="frm-bao-cao-tuan" name="frm-bao-cao-tuan"><div class="wrapper d-block d-sm-flex align-items-center justify-content-between">
                          ...
                          <ul class="nav nav-tabs tab-solid tab-solid-primary mb-0" id="myTab" role="tablist">
                            ...
                            @if ($checkQuyenXemBaoCaoTongHop==1)
                              ...
                              <li class="nav-item">
                                <a class="nav-link @if($tabActive==4) active @endif" id="chot-va-gui-bao-cao-tab" data-toggle="tab" href="#chot-va-gui-bao-cao" role="tab" aria-controls="tong-hop-va-gui-bao-cao">
                                  @if ($isLanhDao)
                                    Xem & duyệt báo cáo
                                  @else
                                    Tổng hợp
