  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      jQuery('.noi-dung-bao-cao-tuan-hien-tai').on("keypress", function(e) {
        if (e.keyCode == 13) {
          var idTuan=jQuery('#id_tuan').val();
          themMoiVaRefreshDuLieuTheoId2(_token, $("form#frm-bao-cao-tuan-hien-tai"), "{{ route('them-bao-cao-tuan-hien-tai') }}", idTuan, "{{ route('danh-sach-bao-cao-tuan-hien-tai') }}", '.load-danh-sach-bao-cao-tuan-hien-tai', false);
        }
      });
      ...
      jQuery('.noi-dung-bao-cao-ke-hoach-tuan').on("keypress", function(e) {
        if (e.keyCode == 13) {
          var idTuan=jQuery('#id_tuan').val();
          themMoiVaRefreshDuLieuTheoId2(_token, $("form#frm-bao-cao-ke-hoach-tuan"), "{{ route('them-bao-cao-ke-hoach-tuan') }}", idTuan, "{{ route('danh-sach-bao-cao-ke-hoach-tuan') }}", '.load-danh-sach-bao-cao-ke-hoach-tuan', false);
        }
      });
