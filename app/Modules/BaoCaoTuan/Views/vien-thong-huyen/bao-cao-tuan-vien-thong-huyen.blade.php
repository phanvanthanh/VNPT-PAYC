                      ...
                      <div class="card-body" style="min-height: 500px;">
                        <div class="wrapper d-block d-sm-flex align-items-center justify-content-between">
                          ...
                          <ul class="nav nav-tabs tab-solid tab-solid-primary mb-0" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" id="chot-va-gui-bao-cao-tab" data-toggle="tab" href="#chot-va-gui-bao-cao" role="tab" aria-controls="tong-hop-va-gui-bao-cao">Gửi báo cáo</a>
                            </li>
                          </ul>
                        </div>
                        <div class="wrapper">
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      jQuery('.btn-lay-ke-hoach-tuan-truoc').on('click', function() {
        var idTuan=jQuery('#id_tuan').val();
        postAndRefreshById(_token, idTuan, "{{ route('lay-du-lieu-tu-ke-hoach-tuan') }}", idTuan, "{{ route('danh-sach-bao-cao-tuan-hien-tai') }}", '.load-danh-sach-bao-cao-tuan-hien-tai', false);
        return false;
      });
