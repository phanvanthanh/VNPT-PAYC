	    ...
	    <div class="card">
	        <div class="card-body">
                ...
                <div class="text-right">
                    ...
                    <div class="btn-group mr-2">
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-huy"><i class="fa fa-window-close-o"></i> Hủy</button>
                    </div>
                </div>
						            ...
						            <tr class="tr-hover">
						                ...
						                <?php
						                    ...
						                    foreach ($files as $key => $file) {
						                        echo '<a href="/file/download/'.$file.'"><div class="show-file">'.$file.'</div></a><br>';
						                    }
						                ?>
						                </td>
						                <td>
