...
@section('title', 'PAKN chờ tiếp nhận')
@section('content')
	<div class="col-lg-12">
	    <div class="card">
	        <div class="card-body">
	          	<div class="row">
                  <div class="col-6">
                    <h4 class="text-danger">DANH SÁCH PAKN CHỜ TIẾP NHẬN</h4>
                ...
                <div class="text-right">
                    ...
                    @php
                    	...
                    	$checkHuyYeuCau=\Helper::getValueThamSoTheoMa('CHO_PHEP_HUY_YC_KHI_TIEP_NHAN');
                    	if($checkHuyYeuCau==1){
                    	@endphp
							<div class="btn-group mr-2">
