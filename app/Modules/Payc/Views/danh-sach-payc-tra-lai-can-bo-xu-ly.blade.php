	...
	<div class="col-lg-12">
	    <div class="card">
	        <div class="card-body">
	          	<div class="row">
                  <div class="col-6">
                    <h4 class="text-danger">DANH SÁCH PAYC TRẢ LẠI CÁN BỘ XỬ LÝ</h4>
                    <small id="danh-muc-nhom-quyen-helper" class="form-text text-muted">Chức năng sẽ hiển thị danh sách những PAYC chưa đạt yêu cầu cần chuyển lại cán bộ để xử lý và đáp ứng nhu cầu của khách hàng.</small>
                  </div>
                    <div class="col-6">
