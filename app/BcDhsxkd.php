...
class BcDhsxkd extends Model
{
    ...
    protected $fillable=['id','ma_don_vi','ma_dinh_danh', 'id_thoigian_baocao', 'id_user_bao_cao', 'chi_so', 'gia_tri', 'ghi_chu', 'is_group', 'trang_thai', 'sap_xep', 'loai_chi_so'];
